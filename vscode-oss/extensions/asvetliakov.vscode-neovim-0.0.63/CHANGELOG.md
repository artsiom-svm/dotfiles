...
-   Allow to write text decoration (usually EasyMotion ones) at top setting (`vscode-neovim.textDecorationsAtTop"`) ( [#358](https://github.com/asvetliakov/vscode-neovim/issues/358) ), contributed by @jhgarner
-   Fix incorrect `<C-w><C-w>/<C-w>w` mappings ( [#359](https://github.com/asvetliakov/vscode-neovim/issues/359) ), contributed by @tschaei
-   Replace/modernize neovim vscode command line interop mappings with `<Cmd>call` ( [#362](https://github.com/asvetliakov/vscode-neovim/issues/362) ), contributed by @theol0403
...
-   Fix incorrect cursor position when selecting next search result ( [#366](https://github.com/asvetliakov/vscode-neovim/issues/366) )
...
-   Bundle extension with webpack ( [#377](https://github.com/asvetliakov/vscode-neovim/issues/377) )
